...
def hemisphere_data(browser):
    ...
    for image in images:
        ...
        image_scrape = image_soup.find('div', class_= "wide-image-wrapper")
        img_url = image_scrape.find("img", class_ = "wide-image")["src"]    
        hemisphere_data["img_url"] = url + img_url
        hemisphere_data["title"] = titles
